...
public enum BuiltInConstraint {
    ...
    BuiltInConstraint(String camelCaseName, Class<? extends Annotation> beanValidationAnnotation, Class<? extends AbstractConstraintAttributesDecorator> decorator) {
